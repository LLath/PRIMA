...
declare namespace FudgeCore {
  ...
  class Animation extends Mutable implements SerializableResource {
    ...
    constructor(
      _name: string,
      _animStructure?: AnimationStructure,
      _fps?: number
    );
    /**
...
declare namespace FudgeCore {
  ...
  class Audio {
    ...
    constructor(
      ...
      _audioSessionData: AudioSessionData,
      _url: string,
      _gainValue: number,
      _loop: boolean
    );
...
declare namespace FudgeCore {
  ...
  abstract class RenderOperator {
     ...
     */
    protected static createRenderLights(
      _lights: MapLightTypeToLightList
    ): RenderLights;
    /**
     * Set light data in shaders
     */
    protected static setLightsInShader(
     ...
     * @param _projection
     */
    protected static drawForRayCast(
      _id: number,
      _renderBuffers: RenderBuffers,
      _world: Matrix4x4,
      _projection: Matrix4x4
...
declare namespace FudgeCore {
  ...
  abstract class ResourceManager {
     ...
     */
    static registerNodeAsResource(
      _node: Node,
      _replaceWithInstance?: boolean
    ): NodeResource;
    /**
...
declare namespace FudgeCore {
  ...
  class Matrix3x3 {
    ...
    translate(
      _matrix: Matrix3x3,
      _xTranslation: number,
      _yTranslation: number
    ): Matrix3x3;
...
declare namespace FudgeCore {
  ...
  abstract class RenderManager extends RenderOperator {
     ...
     * @param _cmpCamera
     */
    static drawBranchForRayCast(
      _node: Node,
      _cmpCamera: ComponentCamera
    ): PickBuffer[];
    static pickNodeAt(
      _pos: Vector2,
      _pickBuffers: PickBuffer[],
      _rect: Rectangle
    ): RayHit[];
...
declare namespace FudgeCore {
  ...
  class Loop extends EventTargetStatic {
    ...
    static start(
      _mode?: LOOP_MODE,
      _fps?: number,
      _syncWithAnimationFrame?: boolean
    ): void;
    /**
     * Stops the loop
     */
